...
- Matched catalog photographs are reviewed complete destination states. The author mask localizes the touch and reconstruction treatment, but the final reveal swaps the complete matched photograph to avoid partial-composite seams. Small whole-image texture differences may still be visible during before/after scrubbing.
